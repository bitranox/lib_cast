...
setup(name='lib_cast',
      ...
      install_requires=['typing', 'lib_regexp @ git+https://github.com/bitranox/lib_regexp.git'],
      # minimally needs to run the setup script, dependencies needs also to put here for setup.py install test
      setup_requires=['pytest-runner', 'lib_regexp @ git+https://github.com/bitranox/lib_regexp.git'],
